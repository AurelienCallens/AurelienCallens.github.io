...
library(skimr)
library(magrittr)
session_data <- read_csv("/home/aurelien/Dropbox/Side projects/FIshing_app/raw_data/session.csv")[-c(1:2),]
catch_data <- read_csv("/home/aurelien/Dropbox/Side projects/FIshing_app/raw_data/catch.csv")
```
...
+ Summary table of the first file: 
...
&nbsp;
  ...
  + Summary table of the second file: 
